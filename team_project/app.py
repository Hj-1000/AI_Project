...
model = YOLO("C:/Users/Administrator/Desktop/AI/wtdc/team_project/best3.pt")
...
def generate_all():
    ...
    cap = cv2.VideoCapture("C:/Users/Administrator/Desktop/AI/wtdc/team_project/video_file/An Bokgaecheon intersection.mp4")  # 영상 열기 (Open video)
